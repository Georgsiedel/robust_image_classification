...
style_gen = {'probability': 0.3, 'alpha_min': 0.1, 'alpha_max': 1.0}
...
{'noise_type': 'uniform-l1', 'epsilon': 938.9, 'sphere': False, 'distribution': 'max'},
{'noise_type': 'uniform-l2', 'epsilon': 3.875, 'sphere': False, 'distribution': 'max'},
{'noise_type': 'uniform-linf', 'epsilon': 0.08893, 'sphere': False, 'distribution': 'max'},
