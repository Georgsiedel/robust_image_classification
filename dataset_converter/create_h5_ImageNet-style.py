...
if __name__ == "__main__":
    ...
    ap.add_argument("--src", default="../data/ImageNet-100-synthetic", help="ImageFolder root")
    ap.add_argument("--out", default="../data/ImageNet-100-add-1m-dm.h5", help="Output HDF5 file path")
