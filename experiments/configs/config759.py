...
train_aug_strat_orig = 'PRIME' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
train_aug_strat_gen = 'PRIME' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
...
adv_distance_params = {'setsize': 1000, 'iters_pgd': 1000, 'eps_iter': [0.0001,0.01,0.5], 'iters_second_attack': 40, 'norm': ['inf', 2, 1],
                       "clever": False, "clever_batches": [10], "clever_samples": [10]}
calculate_autoattack_robustness = True
autoattack_params = {'setsize': 1000, 'epsilon': [1/255, 20], 'norm': ['Linf', 'L1']}
