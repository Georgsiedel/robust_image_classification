...
if __name__ == '__main__':
    ...
    for experiment in [212,213,214,215,216,494,495,496,515,516,517,518,394,395,396,397,398,399,593,594,595,596,597]:#
        ...
        for run in run_iters:
            ...
            resume = True if experiment in [212] and run in [0] else False
