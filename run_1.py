...
if __name__ == '__main__':
    ...
    for experiment in [515,516,517,518,394,395,396,397,398,399,593,594,595,596,597,219,220,221,222,223,224,269,270,271,272,273,274]:#
        ...
        for run in run_iters:
            ...
            resume = True if experiment in [515] and run in [0] else False
